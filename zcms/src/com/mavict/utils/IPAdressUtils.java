...
public class IPAdressUtils {
	/**
	 ...
	 public static String getAddresses(String content, String encodingString) throws UnsupportedEncodingException {
		 String urlStr = "http://ip.taobao.com/service/getIpInfo.php"; // 调用taobao的接口
		 String returnStr = getResult(urlStr, content, encodingString);// 取得IP所在的省市区信息
		 if (returnStr != null) {
		 // 处理返回的省市区信息
