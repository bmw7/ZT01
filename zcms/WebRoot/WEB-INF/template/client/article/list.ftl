...
<tr>
<td align="center" width="30"><img src="${base}/resource/client/images/listicon.gif" /></td>
<td><a href="${base}/articles/${article.id}.html">${article.title}</a></td>
<td width="80" align="right">${(article.createDate)?string("yyyy-MM-dd")}&nbsp;&nbsp;</td>
</tr>
...
<div id="main_line"><div id="foot_inner"></div></div>
